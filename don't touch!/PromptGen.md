...
First ask the user clarifying questions and receive answers to them.
Taking into account the user's answers, provide them with a complete system prompt without unnecessary explanations in MarkDown format.